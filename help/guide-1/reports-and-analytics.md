...
2015 年のAnalysis Workspaceのリリース以降、Reports &amp; Analytics の機能はAnalysis Workspaceに移行され、同等のワークフロー機能を提供できるようになりました。[この提供終了のお知らせでは &#x200B;](https://new.express.adobe.com/webpage/WFCyq7w8kijmB?) 提供終了プロセスについて説明します。
