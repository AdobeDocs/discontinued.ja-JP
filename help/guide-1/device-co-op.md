...
title: '"[!DNL Device Co-op] 提供終了に関する FAQ »'
...
# [!DNL Device Co-op] 提供終了に関する FAQ

このドキュメントでは、 [!DNL Adobe Experience Cloud Device Co-op] 提供終了 (EOL) プラン。 この計画が実施されると、Adobeは、 [Experience Cloudリリースノート](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) そして [優先製品アップデート](https://www.adobe.com/subscription/priority-product-update.html).

[!DNL Device Co-op] は、最高水準のプライバシーと透明性を確保しながら、参加企業の連携によって複数のデジタルタッチポイントを持つ消費者をより正確に識別できるようにするプログラムです。
