---
title: '[!DNL Adobe Experience Platform Auditor]の提供終了'
...
[!DNL Adobe Experience Platform Auditor]は、CX Enterpriseの実装を評価するレポートを生成し、それを改善する方法を示すポインターを提供できるシステムでした。 [!DNL Adobe Experience Platform Auditor] はサービス終了（EOL）となり、現在はアクティブではありません。
