...
[!DNL Adobe Experience Cloud][!DNL Adobe Experience Platform Auditor] 実装を評価し、改善方法について助言するレポートを生成できるシステムでした。[!DNL Adobe Experience Platform Auditor] は、提供終了（EOL）に達し、アクティブではなくなりました。
